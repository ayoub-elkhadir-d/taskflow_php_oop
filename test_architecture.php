<?php
require_once __DIR__ . '\taskflow\src\Entities\Administrator.php';
...
try {
    ...
    // Check inheritance
    if ($developer instanceof \src\Entities\TeamMember) {
        echo " PASS: Developer extends TeamMember\n";
    }
    
    if ($manager instanceof \src\Entities\TeamMember) {
